...
asteroidSound = loadSound("asteroidHit.mp3");
playerShoot = loadSound("playerShoot.mp3");
compShoot = loadSound("compPlayShoot.mp3");
shipTouch = loadSound("shipCollide.mp3");
...
if(player.isTouching(asteroidsGroup) && score>1){
  score = score-0.2;
  asteroidSound.play();
}
...
if(asteroidsGroup.isTouching(playerLazer)){
